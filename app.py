...
def venues():
  ...
  for city in cities:
    ...
    print(venues[0].state)
    vnu = []
    for venue in venues:
      ven = {"id":venue.id, "name":venue.name, "num_upcoming_shows":0}
      vnu.append(ven)
    dataya = {"city":city[0], "state":venues[0].state, "venues":vnu}
    datay.append(dataya)
    print(venues[0].id)
  ...
  return render_template('pages/venues.html', areas=datay)
...
def search_venues():
  ...
  return render_template('pages/search_venues.html', results=responser, search_term=request.form.get('search_term', ''))
...
def show_venue(venue_id):
  ...
  datay["past_shows"]=past_shows
  datay["upcoming_shows"]=upcoming_shows
  datay["past_shows_count"]=len(past_shows)
  datay["upcoming_shows_count"]=len(upcoming_shows)
  ...
  return render_template('pages/show_venue.html', venue=datay)
...
def artists():
  ...
  for artist in artists:
    ...
    datay.append(individual_artist)
  #=========================================================
  data=[{
    "id": 4,
    "name": "Guns N Petals",
  ...
  return render_template('pages/artists.html', artists=datay)
...
def search_artists():
  ...
  return render_template('pages/search_artists.html', results=responser, search_term=request.form.get('search_term', ''))
...
def show_artist(artist_id):
  ...
  datay = {
    "id": artist_.id,
    "name": artist_.name,
    "genres": artist_.genres,
    "city": artist_.city,
    "state": artist_.state,
    "phone": artist_.phone,
    "website": artist_.website_link,
    "facebook_link": artist_.facebook_link,
    "seeking_venue": artist_.seeking_venue,
    "seeking_description": artist_.seeking_description,
    "image_link": artist_.image_link,
  }
  current_time= datetime.today()
  ...
  return render_template('pages/show_artist.html', artist=datay)
...
def edit_artist(artist_id):
  ...
  return render_template('forms/edit_artist.html', form=form, artist=artisty)
...
def edit_venue(venue_id):
  ...
  return render_template('forms/edit_venue.html', form=form, venue=venuewe)
...
def shows():
  ...
  for show in shows:
    ...
    if show.venue_id:
      dataya['venue_id'] = venue.id
      dataya['venue_name'] = venue.name

    if show.artist_id:
      dataya['artist_id'] = artist.id
      dataya['artist_name'] = artist.name
      dataya['artist_image_link'] = artist.image_link
  ...
  return render_template('pages/shows.html', shows=datay)
